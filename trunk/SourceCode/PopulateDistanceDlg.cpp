...
void PopulateDistanceDlg::OnCalculate()
   ...
   if ( IsDlgButtonChecked( IDC_POPULATECOUNT ) )
      ...
      pTargetLayer->PopulateNearestDistanceToCoverage( pSourceLayer, col, 5000, pSourceQuery, pTargetQuery, NULL, colNearestToIndex, colNearestToValue, colNearestSourceValue );
