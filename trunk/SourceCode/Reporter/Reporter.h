...
public:
   ...
   // note:  OutputGroups never hold summarize data, that is always defined at the Output level
...
class Reporter : public EnvAutoProcess
{
public:
   Reporter( void );
   ~Reporter( void );
   ...
   int  LoadXmlOutputs( TiXmlElement *pXmlParent, OutputGroup *pGroup, MapLayer *pLayer, LPCTSTR filename );
