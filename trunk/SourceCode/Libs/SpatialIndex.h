...
public:
   ...
   bool HasExtendedSpatialInfoEx(LPCSTR filename, int & errorCode); // 
...
public:
   ...
   int  WriteIndex( LPCSTR filename );
   ...
   int  ReadIndex( LPCSTR filename, MapLayer *pLayer, MapLayer *pToLayer, int records );
   ...
   static int GetSpatialIndexInfo( LPCSTR filename, float &distance,int &count );
