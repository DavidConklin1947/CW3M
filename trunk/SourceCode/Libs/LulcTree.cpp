...
int LulcTree::LoadLulcInfo( LPCSTR filename )
   {
...
int LulcTree::LoadXml( LPCSTR _filename, bool isImporting, bool appendToExisting )
   {
...
int LulcTree::LoadXml( TiXmlNode *pLulcTree, bool appendToExisting )
   ...
   while( pXmlClassNode = pLulcTree->IterateChildren( pXmlClassNode ) )
      ...
      LPCTSTR col  = pXmlClassElement->Attribute( _T("col") );
