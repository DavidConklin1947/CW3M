...
//double DDataObj::IGet(double x, int xcol, int ycol/*= 1*/, IMETHOD method/*=IM_LINEAR*/, int startRow/*=0*/, int *returnRow/*=NULL*/, bool forwardSearch/*=true*/)
//{
// double x1;
...
int DDataObj::AppendCol(LPCSTR label) //, double *dataArray /*=NULL*/ )
{
	double *dataArray = new double[GetRowCount()];
...
int DDataObj::InsertCol(int insertBefore, LPCSTR label)
{
	bool alloc = false;
...
int DDataObj::ReadAscii(LPCSTR _fileName, TCHAR delimeter, BOOL showMsg)
{
	CString fileName;
...
int DDataObj::ReadXls(LPCSTR fileName)
{
...
int DDataObj::WriteAscii(LPCSTR fileName, TCHAR delimiter, int colWidth)
{
