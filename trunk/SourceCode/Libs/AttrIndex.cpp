...
int AttrIndex::WriteIndex( LPCSTR filename /*=NULL*/ )
   {
...
void AttrIndex::GetDefaultFilename( CString &filename )
   ...
   char _filename[ 128 ];
   lstrcpy( _filename, (LPCSTR) m_pDbTable->m_databaseName );
...
int AttrIndex::ReadIndex( DbTable *pDbTable, LPCSTR filename /*=NULL*/ )
   {
