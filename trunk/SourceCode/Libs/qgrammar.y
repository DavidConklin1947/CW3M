...
%token <ivalue> FIELD
%token <ivalue> NEXTTO NEXTTOAREA WITHIN WITHINAREA EXPAND MOVAVG
...
fieldRef:
	FIELD								{ $$ = new QNode( _gpQueryEngine->GetMapLayer(), $1, NULL ); }
...
struct KEYWORD { int type; char *keyword; int ivalue; };
