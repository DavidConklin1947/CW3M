...
bool SplashDlg::CreateNewProject()
   ...
   if ( newIniDlg.DoModal() == ID_WIZFINISH )
      ...
      // create default INI file (with default policy file )
      EnvLoader loader;
      loader.LoadLayer( gpMapPanel->m_pMap, _T("IDU"), newIniDlg.m_step2.m_pathLayer, LT_POLYGON, 1, 0, 0, 0, 0, -1, NULL, NULL, true );
