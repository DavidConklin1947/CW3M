...
protected:
   ...
   PtrArray< ENV_ANALYSISMODULE > m_analysisModuleArray;
   PtrArray< ENV_VISUALIZER > m_visualizerArray;
   PtrArray< ENV_DATAMODULE > m_dataModuleArray;
...
public:
   ENV_ANALYSISMODULE *GetAnalysisModule( int i ) { return m_analysisModuleArray[ i ]; }
   ...
   int  AddAnalysisModule( ENV_ANALYSISMODULE *pInfo ) { return (int) m_analysisModuleArray.Add( pInfo ); }
   /*
   ENV_VISUALIZER *GetVisualizer( int i ) { return m_visualizerArray[ i ]; }
   int  GetVisualizerCount( ) { return (int) m_visualizerArray.GetSize(); }
   void RemoveVisualizer( int i ) { m_visualizerArray.RemoveAt( i ); }
   int  AddVisualizer( ENV_VISUALIZER *pInfo ) { return (int) m_visualizerArray.Add( pInfo ); }
   */
   ENV_DATAMODULE *GetDataModule( int i ) { return m_dataModuleArray[ i ]; }
   int  GetDataModuleCount( ) { return (int) m_dataModuleArray.GetSize(); }
   void RemoveDataModule( int i ) { m_dataModuleArray.RemoveAt( i ); }
   int  AddDataModule( ENV_DATAMODULE *pInfo ) { return (int) m_dataModuleArray.Add( pInfo ); }
...
public:
   //int  LoadDB( LPCSTR filename );
   //int  LoadDBWeb( LPCSTR url );
...
protected:
   ...
   MapLayer *AddMapLayer( LPCSTR filename, int type, int extraCols, int includeData, int records, bool loadFieldInfo );
