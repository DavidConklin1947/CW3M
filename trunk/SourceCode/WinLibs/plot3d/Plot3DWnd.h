...
class Axis
   ...
   public:
      ...
      void SetLabel( LPCSTR label ){ m_label = label; }
...
public:
   ...
   void SetAxesLabels( LPCSTR xLabel, LPCSTR yLabel, LPCSTR zLabel );
   ...
   void SetAxesLabels2( LPCSTR xLabel, LPCSTR yLabel, LPCSTR zLabel );
