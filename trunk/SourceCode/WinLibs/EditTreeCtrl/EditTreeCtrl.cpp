   ...
   : m_pDragData(0)
{
   ...
   m_Commandmap[ID_ADD_SIBLING]        = &CEditTreeCtrl::DoInsertSibling;
   m_Commandmap[ID_DELETE]             = &CEditTreeCtrl::DoDeleteItem;
   m_Commandmap[ID_SORT_LEVEL]         = &CEditTreeCtrl::DoSortCurrentLevel;
   m_Commandmap[ID_SORT_LEVELANDBELOW] = &CEditTreeCtrl::DoSortCurrentLevelAndBelow;
}
