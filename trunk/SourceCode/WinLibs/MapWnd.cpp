...
void MapWindow::SaveAsEnhancedMetafile( LPCSTR filename, int drawFlag )
   {
   // create a device context and draw the map...
   CDC *pDevDC = GetDC();
...
void MapWindow::DrawText(LPCSTR str, int x, int y, CFont *pFont /*=NULL*/ )    // NOTE: x, y are screen coordinates
   {
   CDC *pDC = GetDC();
