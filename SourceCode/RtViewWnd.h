...
public:
   RtVisualizer( RtViewPage *pParent, int run, ENV_VISUALIZER *pInfo, CRect &rect )
...
protected:
   ENV_VISUALIZER *m_pInfo;    // points to structure maintained by CEnvDoc
...
public:
   ...
   ENV_VISUALIZER *GetVisualizerInfo( int i ) { return m_pInfo; }
