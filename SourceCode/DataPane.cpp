...
IMPLEMENT_DYNCREATE(DataPane, CWnd)
...
void DataPane::DoDataExchange(CDataExchange* pDX)
{
	CWnd::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(DataPane, CWnd)
END_MESSAGE_MAP()


// DataPane diagnostics

#ifdef _DEBUG
void DataPane::AssertValid() const
{
	CWnd::AssertValid();
}

#ifndef _WIN32_WCE
void DataPane::Dump(CDumpContext& dc) const
{
	CWnd::Dump(dc);
}
#endif
...
BEGIN_MESSAGE_MAP(DataCtrl,CUGCtrl)
	//{{AFX_MSG_MAP(DataCtrl)
...
/////////////////////////////////////////////////////////////////////////////
// Standard DataCtrl construction/destruction
DataCtrl::DataCtrl()
{
}
...
//	Return:
//		<none>
void DataCtrl::OnSheetSetup(int sheetNumber)
{
...
int DataCtrl::OnCanMove(int oldcol,long oldrow,int newcol,long newrow)
{
...
int DataCtrl::OnCanViewMove(int oldcol,long oldrow,int newcol,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newcol);
...
//	Return:
//		<none>
void DataCtrl::OnHitBottom(long numrows,long rowspast,long rowsfound)
{
...
//	Return:
//		<none>
void DataCtrl::OnHitTop(long numrows,long rowspast)
{
	UNREFERENCED_PARAMETER(numrows);
	UNREFERENCED_PARAMETER(rowspast);
}
...
int DataCtrl::OnCanSizeCol(int col)
{
...
//	Return:
//		<none>
void DataCtrl::OnColSizing(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
...
//	Return:
//		<none>
void DataCtrl::OnColSized(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*width);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int DataCtrl::OnCanSizeRow(long row)
{
...
//	Return:
//		<none>
void DataCtrl::OnRowSizing(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void DataCtrl::OnRowSized(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*height);
}
...
int DataCtrl::OnSideHdgSizing(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
int DataCtrl::OnSideHdgSized(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
//		TRUE - to accept current new size
//		FALSE - to stop sizing, the size is either too large or too small
int DataCtrl::OnTopHdgSizing(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//		TRUE - to accept new size
//		FALSE - to revert to old size
int DataCtrl::OnTopHdgSized(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//	Return:
//		<none>
void DataCtrl::OnColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void DataCtrl::OnRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void DataCtrl::OnCellChange(int oldcol,int newcol,long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
	UNREFERENCED_PARAMETER(oldrow);
...
//	Return:
//		<none>
void DataCtrl::OnLeftColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void DataCtrl::OnTopRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void DataCtrl::OnViewMoved( int nScrolDir, long oldPos, long newPos )
{
...
//	Return:
//		<none>
void DataCtrl::OnSelectionChanged(int startCol,long startRow,int endCol,long endRow,int blockNum)
{
...
//	Return:
//		<none>
void DataCtrl::OnLClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void DataCtrl::OnRClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void DataCtrl::OnDClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void DataCtrl::OnMouseMove(int col,long row,POINT *point,UINT nFlags,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void DataCtrl::OnTH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void DataCtrl::OnTH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void DataCtrl::OnTH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void DataCtrl::OnSH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void DataCtrl::OnSH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void DataCtrl::OnSH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void DataCtrl::OnCB_LClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void DataCtrl::OnCB_RClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void DataCtrl::OnCB_DClicked(RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
	UNREFERENCED_PARAMETER(processed);
...
//	Return:
//		<none>
void DataCtrl::OnKeyDown(UINT *vcKey,BOOL processed)
{
...
//	Return:
//		<none>
void DataCtrl::OnKeyUp(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void DataCtrl::OnCharDown(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void DataCtrl::OnGetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void DataCtrl::OnSetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
...
//	Return:
//		<none>
void DataCtrl::OnDataSourceNotify(int ID,long msg,long param)
{
...
int DataCtrl::OnCellTypeNotify(long ID,int col,long row,long msg,LONG_PTR param)
{
	UNREFERENCED_PARAMETER(ID);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int DataCtrl::OnEditStart(int col, long row,CWnd **edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int DataCtrl::OnEditVerify(int col, long row,CWnd *edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int DataCtrl::OnEditFinish(int col, long row,CWnd *edit,LPCTSTR string,BOOL cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int DataCtrl::OnEditContinue(int oldcol,long oldrow,int* newcol,long* newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(*newcol);
...
//	Return:
//		<none>
void DataCtrl::OnMenuCommand(int col,long row,int section,int item)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int DataCtrl::OnMenuStart(int col,long row,int section)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
DWORD DataCtrl::OnGetContextHelpID( int col, long row, int section )
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
int DataCtrl::OnHint(int col,long row,int section,CString *string)
{
	UNREFERENCED_PARAMETER(section);
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int DataCtrl::OnVScrollHint(long row,CString *string)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int DataCtrl::OnHScrollHint(int col,CString *string)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
DROPEFFECT DataCtrl::OnDragEnter(COleDataObject* pDataObject)
{
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT DataCtrl::OnDragOver(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT DataCtrl::OnDragDrop(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void DataCtrl::OnScreenDCSetup(CDC *dc,int section)
{
...
int DataCtrl::OnSortEvaluate(CUGCell *cell1,CUGCell *cell2,int flags)
{
...
//	Return:
//		<none>
void DataCtrl::OnTabSelected(int ID)
{
	UNREFERENCED_PARAMETER(ID);
}
...
//	Return:
//		<none>
void DataCtrl::OnAdjustComponentSizes(RECT *grid,RECT *topHdg,RECT *sideHdg,
...
//	Return:
//		<none>
void DataCtrl::OnDrawFocusRect(CDC *dc,RECT *rect)
{
...
COLORREF DataCtrl::OnGetDefBackColor(int section)
{
	UNREFERENCED_PARAMETER(section);
...
//		<none>
//
void DataCtrl::OnSetFocus(int section)
{
	UNREFERENCED_PARAMETER(section);
}
...
//	Return:
//		<none>
void DataCtrl::OnKillFocus(int section, CWnd *pNewWnd)
{
	UNREFERENCED_PARAMETER(section);
}
...
BOOL DataCtrl::OnColSwapStart(int col)
{
	UNREFERENCED_PARAMETER(col);
	return TRUE;
}
...
//		TRUE - to allow for the swap to take place
//		FALSE - to disallow the swap
BOOL DataCtrl::OnCanColSwap(int fromCol,int toCol)
{
...
//	Return:
//		<none>
void DataCtrl::OnColSwapped(int fromCol,int toCol)
{
	UNREFERENCED_PARAMETER(fromCol);
	UNREFERENCED_PARAMETER(toCol);
}
...
//	Return:
//		<none>
void DataCtrl::OnTrackingWindowMoved(RECT *origRect,RECT *newRect)
{
