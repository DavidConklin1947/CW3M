...
int VDataObj::WriteAscii( LPCSTR fileName, TCHAR delimiter, int colWidth )
   {
...
int VDataObj::AppendCol( LPCSTR label ) //, VData *dataArray /*=NULL*/ )
   {
   VData *dataArray = new VData[ GetRowCount() ];
...
int VDataObj::InsertCol( int insertBefore, LPCSTR label )//, VData *dataArray /*=NULL*/ )
   {
   VData *dataArray = new VData[ GetRowCount() ];
