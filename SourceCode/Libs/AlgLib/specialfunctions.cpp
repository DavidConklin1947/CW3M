...
double beta(double a, double b, ae_state *_state)
{
    ...
    sg = 1;
    ae_assert(ae_fp_greater(a,0)||ae_fp_neq(a,(double)ae_ifloor(a, _state)), "Overflow in Beta", _state);
    ae_assert(ae_fp_greater(b,0)||ae_fp_neq(b,(double)ae_ifloor(b, _state)), "Overflow in Beta", _state);
    y = a+b;
