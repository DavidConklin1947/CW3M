...
class  LIBSAPI VDataObj : public DataObj
   ...
   public:
      ...
      virtual bool Set( int col, int row, LPCSTR value ) { VData v; v.SetAsDString( value ); return Set( col, row, v ); }
      ...
      virtual int  AppendCol( LPCSTR label );  // VData *dataArray=NULL );
      virtual int  InsertCol( int insertBefore, LPCSTR label ); //, VData *dataArray=NULL );
